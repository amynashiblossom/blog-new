          ...
          <div className="p-3.5 bg-[#FAF5E8] border border-[#EAE5DC] rounded-xl text-[11px] text-[#6A6A6A] leading-relaxed flex items-start gap-2.5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[#3A3A3A]">
                • <strong className="text-[#0A0A0A]">로컬 암호화 보관</strong>: 소속(전/현) 기업의 비공개 매출·실적, 내부 프로젝트명, 파트너사명 등 <strong>경영민감정보(Business-Sensitive Info)</strong>와 아카이빙 데이터는 외부 서버에 저장되지 않으며, 암호화(XOR+Base64)되어 오직 사용자의 로컬 브라우저에만 안전하게 보관됩니다.
              </p>
              <p className="text-[#3A3A3A]">
                • <strong className="text-[#0A0A0A]">PII 비식별화 & AI 전송</strong>: 이메일·연락처 등 직접 식별자(Direct PII)는 원천 마스킹되며, 직무 적합도 1:1 갭 분석에 필요한 경력/성과 원문은 비학습(Zero Data Retention) 파이프라인으로 전달됩니다.
              </p>
              <p className="text-[#8A5B00] font-medium pt-0.5">
                * 다만 커리어핏과 무관하게 Gemini 자체 정책에 의해 수집/활용되는 부분에 대해서는 서비스 책임 한계(Disclaimer)가 적용됨을 고지합니다.
              </p>
            </div>
          </div>
